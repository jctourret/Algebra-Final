...
namespace CustomMath
{
    ...
    public struct MiMatriz4x4{
        public float r0c0; public float r0c1; public float r0c2; public float r0c3;
        public float r1c0; public float r1c1; public float r1c2; public float r1c3;
        public float r2c0; public float r2c1; public float r2c2; public float r2c3;
        public float r3c0; public float r3c1; public float r3c2; public float r3c3;
        ...
        public static MiMatriz4x4 Rotate(Quats q){
            ...
            MiMatriz4x4 m = zero;
            m.r0c0 = 1.0f - (2.0f * q.y * q.y) - (2.0f * q.z * q.z); m.r0c1 = 2.0f * q.x * q.y - 2.0f * q.z * q.w;        m.r0c2 = 2.0f * q.x * q.z + 2.0f * q.y * q.w;         m.r0c3 = 0.0f;
            m.r1c0 = 2.0f * q.x * q.y + 2.0f * q.z * q.w;            m.r1c1 = 1.0f - 2.0f * q.x * q.z - 2.0f * q.z * q.z; m.r1c2 = 2.0f * q.y * q.z - 2.0f * q.x * q.w;         m.r1c3 = 0.0f;
            m.r2c0 = 2.0f * q.x * q.z - 2.0f * q.y * q.w;            m.r2c1 = 2.0f * q.y * q.z + 2.0f * q.x * q.w;        m.r2c2 = 1.0f - 2.0f * q.x * q.x - 2.0f * q.y * q.y;  m.r2c3 = 0.0f;
            m.r3c0 = 0.0f;                                           m.r3c1 = 0.0f;                                       m.r3c2 = 0.0f;                                        m.r3c3 = 1.0f;

            // m.r0c0 = Mathf.Cos(angel.y) * Mathf.Cos(angel.z); m.r0c1 = -Mathf.Sin(angel.z);                     m.r0c2 = Mathf.Sin(angel.y);                      m.r0c3 = 0.0f;
            // m.r1c0 = Mathf.Sin(angel.z);                      m.r1c1 = Mathf.Cos(angel.x) * Mathf.Cos(angel.z); m.r1c2 = -Mathf.Sin(angel.x);                     m.r1c3 = 0.0f;
            // m.r2c0 = -Mathf.Sin(angel.y);                     m.r2c1 = Mathf.Sin(angel.x);                      m.r2c2 = Mathf.Cos(angel.x) * Mathf.Sin(angel.y); m.r2c3 = 0.0f;
            // m.r3c0 = 0.0f;                                    m.r3c1 = 0.0f;                                    m.r3c2 = 0.0f;                                    m.r3c3 = 1.0f;
        ...
        public static Vector4 operator *(MiMatriz4x4 lhs, Vector4 vector){
            ...
            result.y = lhs.r1c0 * vector.x + lhs.r1c1 * vector.y + lhs.r1c2 * vector.z + lhs.r1c3 * vector.w;
            result.z = lhs.r2c0 * vector.x + lhs.r2c1 * vector.y + lhs.r2c2 * vector.z + lhs.r2c3 * vector.w;
            result.w = lhs.r3c0 * vector.x + lhs.r3c1 * vector.y + lhs.r3c2 * vector.z + lhs.r3c3 * vector.w;
        ...
        public static MiMatriz4x4 operator *(MiMatriz4x4 lhs, MiMatriz4x4 rhs){
            ...
            result.r1c2 = (lhs.r1c0 * rhs.r0c2 + lhs.r1c1 * rhs.r1c2 + lhs.r1c2 * rhs.r2c2 + lhs.r1c3 * rhs.r3c2);
            result.r2c2 = (lhs.r2c0 * rhs.r0c2 + lhs.r2c1 * rhs.r1c2 + lhs.r2c2 * rhs.r2c2 + lhs.r2c3 * rhs.r3c2);
            result.r3c2 = (lhs.r3c0 * rhs.r0c2 + lhs.r3c1 * rhs.r1c2 + lhs.r3c2 * rhs.r2c2 + lhs.r3c3 * rhs.r3c2);
        ...
        {
            return (lhs.r0c0 == rhs.r0c0 && lhs.r0c1 == rhs.r0c1 && lhs.r0c2 == rhs.r0c2 && lhs.r0c3 == rhs.r0c3 &&
